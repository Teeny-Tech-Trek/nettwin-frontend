...
function launchConfetti(canvas: HTMLCanvasElement) {
  ...
  const colors = ['#06b6d4', '#14b8a6', '#3b82f6', '#10b981', '#f59e0b', '#ec4899', '#f97316'];
...
const TourArrow: React.FC<{ placement: Placement; targetRect: Rect }> = ({
  ...
  return (
    <motion.div
      ...
      style={{ position: 'fixed', color: '#06b6d4' }}
    >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
              ...
              all the powerful features of your twin dashboard.
            </p>
          </motion.div>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            You're now ready to explore everything NetTwin has to offer. Train your twin, view conversation transcripts, and share your brand!
          </p>
        </motion.div>
